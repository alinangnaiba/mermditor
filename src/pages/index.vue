    ...
    <header class="py-4 px-6 border-b border-slate-800 flex-shrink-0">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="flex items-center space-x-4">
            <RouterLink to="/cheatsheet" class="text-gray-300 hover:text-white">Cheat Sheet</RouterLink>
        </nav>
      </div>
    </header>    
    <!-- Main Content Area -->
    <main class="flex-grow flex flex-col">
      ...
      <section class="py-12 md:py-20 flex flex-col items-center justify-center">
        ...
        <div class="max-w-3xl mx-auto">
          <h2 class="text-5xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 flex flex-col md:flex-row items-center justify-center text-brand-blue">
            <img src="@/assets/logo.png" alt="merMDitor Logo" class="h-10 sm:h-12 md:h-14 lg:h-16 mb-4 md:mb-0 md:mr-4" />
            merMDitor
          </h2>
          <p class="text-xl sm:text-2xl md:text-3xl text-gray-300 mb-6">Markdown editor with <a href="https://mermaid.js.org/" target="_blank" rel="noopener noreferrer" class="text-slate-400 hover:text-slate-300 underline">Mermaid</a> syntax support</p>
      ...
      <section class="py-16 bg-slate-800">
        <div class="container mx-auto px-4">
          <h3 class="text-3xl font-bold text-center mb-12 text-brand-blue">Key Features</h3>
      ...
      <section class="py-16 bg-slate-900">
        <div class="container mx-auto px-4">
          <h3 class="text-3xl font-bold text-center mb-12 text-brand-blue">Ideal Use Cases</h3>
          <p class="text-lg text-gray-400 text-center mb-10 max-w-2xl mx-auto">merMDitor is a versatile tool designed to simplify documentation and visualization for several key user groups.</p>
