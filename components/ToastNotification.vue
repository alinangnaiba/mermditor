    ...
    <div class="toast-container fixed top-4 right-4 z-50 space-y-2">
      ...
      >
        <div
          ...
          :key="toast.id"
          class="toast-item flex items-center justify-between rounded-lg px-4 py-3 shadow-lg backdrop-blur-sm border max-w-sm"
        ...
        >
          ...
          <!-- Close button -->
          <button
            class="ml-4 flex-shrink-0 rounded-md p-1.5 transition-colors hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-white/20"
