  ...
  <div class="mermaid-wrapper">
    <div class="mermaid-controls">
      <button
        ...
        class="focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 focus:ring-offset-surface-primary"
        @click="zoomIn"
      >
        <svg
      ...
      <button
        title="Zoom Out"
        aria-label="Zoom out on diagram"
        class="focus:outline-none focus:ring-2 focus:ring-accent-primary focus:ring-offset-2 focus:ring-offset-surface-primary"
        @click="zoomOut"
      >
        <svg
...
.mermaid-controls {
  ...
  display: flex;
  gap: 4px;
  background-color: rgba(var(--surface-secondary-rgb), 0.9);
  padding: 4px;
  border-radius: 6px;
  box-shadow: 0 2px 6px rgba(0, 0, 0, 0.3);
  border: 1px solid rgb(var(--border-primary-rgb));
}
...
.mermaid-controls button:hover {
  background-color: rgba(var(--surface-tertiary-rgb), 0.8);
...
.mermaid-loading {
  ...
  text-align: center;
  font-style: italic;
  border: 1px dashed rgb(var(--accent-primary-rgb));
  border-radius: 4px;
